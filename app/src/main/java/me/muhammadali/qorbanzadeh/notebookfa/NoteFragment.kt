...
import me.muhammadali.qorbanzadeh.notebookfa.databinding.FragmentNoteBinding
import me.muhammadali.qorbanzadeh.notebookfa.utilities.InjectorUtils
import me.muhammadali.qorbanzadeh.notebookfa.utilities.NoteViewModelFactory
...
class NoteFragment : Fragment() {
    ...
    private val noteFragmentViewModel: NoteFragmentViewModel by lazy {
        ...
        ViewModelProviders.of(this,
            NoteViewModelFactory(
                InjectorUtils.getNoteRepository(requireContext())
            )
        )
    ...
    override fun onCreateView(
        ...
        val binding = DataBindingUtil.inflate<FragmentNoteBinding>(inflater,
